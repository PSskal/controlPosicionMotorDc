...
# 56 "./mcc_generated_files/system/../system/../system/clock.h"
...
# 46 "./mcc_generated_files/system/../uart/uart1.h" 2
# 1 "./mcc_generated_files/system/system.h" 1
# 47 "./mcc_generated_files/system/../uart/uart1.h" 2
...
# 54 "./mcc_generated_files/system/../uart/uart_drv_interface.h"
typedef struct {
...
# 48 "./mcc_generated_files/system/../uart/uart1.h" 2
# 67 "./mcc_generated_files/system/../uart/uart1.h"
typedef union {
    struct {
        uint8_t perr : 1;
        uint8_t ferr : 1;
...
# 91 "./mcc_generated_files/system/../uart/uart1.h"
void UART1_Initialize(void);
# 100 "./mcc_generated_files/system/../uart/uart1.h"
...
# 142 "./mcc_generated_files/system/../uart/uart1.h"
...
# 215 "./mcc_generated_files/system/../uart/uart1.h"
...
# 248 "./mcc_generated_files/system/../uart/uart1.h"
_Bool UART1_IsRxReady(void);
# 257 "./mcc_generated_files/system/../uart/uart1.h"
_Bool UART1_IsTxReady(void);
# 266 "./mcc_generated_files/system/../uart/uart1.h"
_Bool UART1_IsTxDone(void);
# 276 "./mcc_generated_files/system/../uart/uart1.h"
size_t UART1_ErrorGet(void);
# 286 "./mcc_generated_files/system/../uart/uart1.h"
uint8_t UART1_Read(void);
# 296 "./mcc_generated_files/system/../uart/uart1.h"
...
# 329 "./mcc_generated_files/system/../uart/uart1.h"
...
void fuzzyControl() {
    ...
    ruleActivation1 = fminf(derivativeNegative,errorNegative);
    ruleActivation2 = fminf(derivativeZero,errorNegative);
    ruleActivation3 = fminf(derivativePositive,errorNegative);

    ruleActivation4 = fminf(derivativeNegative,errorZero);
    ruleActivation5 = fminf(derivativeZero,errorZero);
    ruleActivation6 = fminf(derivativePositive,errorZero);

    ruleActivation7 = fminf(derivativeNegative,errorPositive);
    ruleActivation8 = fminf(derivativeZero,errorPositive);
    ruleActivation9 = fminf(derivativePositive,errorPositive);


    maxNegativeOutput = fmaxf(ruleActivation1,ruleActivation2);
    maxZeroOutput = fmaxf(ruleActivation3,ruleActivation4);
    maxZeroOutput = fmaxf(maxZeroOutput,ruleActivation5);
    maxZeroOutput = fmaxf(maxZeroOutput,ruleActivation6);
    maxZeroOutput = fmaxf(maxZeroOutput,ruleActivation7);
    maxPositiveOutput = fmaxf(ruleActivation8,ruleActivation9);
...
void setMotor(float vel, _Bool dir) {

    PWM1_16BIT_SetSlice1Output1DutyCycleRegister((uint16_t)vel);
...
volatile uint16_t millisContador = 0;
...
void temporizador_ISR(void) {
    ...
    if (millisContador >= 10) {
        ...
        dir = (fuzzyControlOutput > 0) ? 1 : 0;
        pwmDuty = fabsf(fuzzyControlOutput);
...
int main(void)
{
    ...
    while (1) {
        ...
        _delay((unsigned long)((100)*(16000000U/4000.0)));
    }
}
