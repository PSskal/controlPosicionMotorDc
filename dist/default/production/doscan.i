...
# 482 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doscan.c"
...
static int vfsfcnvrt(FILE *fp, char *fmt[], va_list ap)
{
    ...
    if ((*fmt)[0] == '%') {
        ...
        asup = width = 0;
# 1226 "C:\\Program Files\\Microchip\\xc8\\v3.00\\pic\\sources\\c99\\common\\doscan.c"
        if (!strncmp(*fmt, "hu", ((sizeof("hu")/sizeof("hu"[0]))-1))) {

            *fmt += ((sizeof("hu")/sizeof("hu"[0]))-1);
            i = atou(fp, &llu);
            if (!(i < 1)) {
                vp = (void *)(*(unsigned short * *)__va_arg(*(unsigned short * **)ap, (unsigned short *)0));
